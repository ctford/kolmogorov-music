...
More seriously, this paper attempts to show that computational musicology can meaningfully shed light on how music works. Also, as in
...
In other words, computational musicology can contribute to musical practice, not just explain it.
...
Computational musicology is part of a rich tradition of information theoretical art and criticism. Music's deep structure and cultural
significance give computational musicology great potential as a source of artistic analysis and inspiration.
...
\bibitem{Computational Musicology} Eduardo Coutinho, Marcelo Gimenes, Joao M. Martins and Eduardo R. Miranda: TODO. 
\bibitem{Three Paradigms of Computer Science} Eden, Amnon. TODO.
...
\bibitem{The Digital Computer as a Musical Instrument} Mathews, M. V., \textid{Science}, 1963. TODO.
\bibitem{Analysis by Compression} Meredith, David: Analysis by Compression, \textit{The Music Encoding Conference}, 2013.
\bibitem{Music, Mind and Meaning} Minsky, Marvin. 1981.
