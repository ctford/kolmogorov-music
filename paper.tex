...
of the resulting value. If there is no way to describe a value more concisely than the value itself, we say that it is
random.
...
(fact
  ...
  (definitional randomness row-row) => 281/2037)
\end{verbatim}
