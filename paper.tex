...
The examples in this paper are all written in Clojure, a dialect of Lisp. I also rely on Leipzig\cite{Leipzig},
...
and Midje\cite{Midje}, a unit testing library.\footnote{Midje allows us to write a unit test as (fact expression => result),
...
\bibitem{Air on the G String} Bach, Johann Sebastian: Air on the G String
\bibitem{The Library of Babel} Borges, Jorge Luis
