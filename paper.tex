...
sue the composers of every marginally successful musical work from now until they fix the law. Previous works have used
complexity analyses to detect copyright infringement\cite{Intrinsic Plaguerism Detection}. Here we take that one step further
and use complexity theory to cause copyright infringement.
...
\bibitem{The Digital Computer as a Musical Instrument} Mathews, M. V., \textit{Science}, 1963. TODO.
