...
because it has missed opportunities to exploit the structure of the piece.
...
to the canon's \verb|f|. By understanding this, we can almost halve the length of the program we need to
produce the piece.
...
A lexicon has the property that every finite string is a substring.
