...
This paper will argue that it can. It will do so by reviewing existing art works that are algorithmic in nature, and
also by using algomusicological concepts to create a new work that challenges our present conception of musical authorship and
copyright. As befits its subject matter, this paper will incorporate conventions and style from literary essays and musicology
papers.
...
can affect the complexity score. Ultimately, the choice of music theory library is difficult, somewhat subjective and
...
argues that the lambda calculus is such a fundamental concept that it deserves to be considered a universal concept that
...
\bibitem{Anti EP} Autechre (Rob Brown and Sean Booth): Anti EP, Warp Records, 1994.
